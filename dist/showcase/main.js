...
throw new Error("Cannot find module \"../dist/icons\"");
...
searchField.addEventListener("keydown", function (event) {
  const newIconSet = __WEBPACK_IMPORTED_MODULE_0__dist_icons__["completeIconSet"].filter((icon) =>
    icon.name.includes(searchField.value)
  );
  buildIconList(newIconSet);
});

buildIconList(__WEBPACK_IMPORTED_MODULE_0__dist_icons__["completeIconSet"]);
